<template>
    <v-dialog v-model="dialog" width="500" persistent>
        <template slot="activator">
            <v-btn flat>Bestaande lidkaart ingeven</v-btn>
        </template>
        <v-card>
            <v-card-text>
                <v-form>
            ...
            <v-card-actions>
                <v-btn :loading="creating" flat v-on:click="save">Opslaan</v-btn>
                <v-btn :disable="creating" flat v-on:click="close">Annuleren</v-btn>
            </v-card-actions>
        </v-card>
