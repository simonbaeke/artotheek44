            ...
            <v-container grid-list-md>
                <v-layout wrap row justify-space-between>
                    <v-flex xs12 md4>
                        ...
                        <v-layout column wrap>
                            <v-flex md6>
                                ...
                                <v-btn v-if="subscription.confirmed" v-on:click="renewDialog=true">Lidkaart
                                    verlengen
                                </v-btn>


                                <v-btn v-if="!subscription.confirmed" v-on:click="confirmDialog=true">Bevestig
                                    Lidkaart
                                </v-btn>
                    ...
                    <div v-if="activeReservation">
                        ...
                        <v-layout>
                            <v-icon-group>
                                <v-btn v-on:click="rentReserveDialog=true">Ontleen</v-btn>
                                <v-btn>Stop reservering</v-btn>
                            </v-icon-group>
                        </v-layout>
